...
// Prepare the Category Dropdown logic
//  cast to (string) to ensure strict comparison works inside the helper
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form action="<?= hs(APP_ADMIN_URL . '/products') ?>" method="POST" enctype="multipart/form-data" novalidate>
        <div class="mb-3">
        ...
        <div class="mb-3 mt-3">
            ...
            <textarea
                ...
                name="description"
                rows="4"
                class="form-control"><?= hs($old['description'] ?? '') ?></textarea>
