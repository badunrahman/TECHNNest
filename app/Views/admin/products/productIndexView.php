    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a class="btn btn-sm btn-primary" href="<?= hs(APP_ADMIN_URL . '/products/create') ?>">
                <span class="me-1">+</span> <?= hs(trans('buttons.createproduct')) ?>
            </a>
        </div>
...
<script>
    // Pass the PHP constant to JavaScript so know the correct folder path
    const APP_BASE_URL = "<?= hs(APP_BASE_URL) ?>";
</script>

<script src="<?= hs(APP_BASE_URL . '/assets/js/search.js?v=2') ?>"></script>
